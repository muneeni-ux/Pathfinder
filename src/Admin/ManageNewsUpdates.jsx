      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Manage articles, sports highlights, and reports.
          </p>
        </div>
        ...
        <div className="flex gap-3 w-full md:w-auto">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-medium shadow-md hover:from-blue-700 hover:to-indigo-700 transition-all"
          >
          ...
          <div className="bg-white w-full h-[95vh] md:h-auto md:max-h-[90vh] md:max-w-2xl md:rounded-xl shadow-2xl flex flex-col animate-in fade-in zoom-in duration-200 rounded-t-2xl">
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none bg-slate-50"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none resize-y bg-slate-50"
            ...
            <div className="p-4 border-t bg-gray-50 md:rounded-b-xl shrink-0 flex justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-xl shadow-md hover:from-blue-700 hover:to-indigo-700 transition-all"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pageItems.map((p) => (
            ...
            >
              ...
              <div className="p-4">
                <h3
                  className="font-bold text-gray-800 line-clamp-1 mb-2"
                  title={p.title}
                >
                  {p.title}
                </h3>
